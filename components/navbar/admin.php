  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="<?= $root ?>dashboard.php">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu py-1">
            <li>
              <a class="dropdown-item text-dark" href="<?= $root ?>posts/create.php">
                <i class="fas fa-plus"></i>
            ...
            <li>
              <a class="dropdown-item text-dark" href="<?= $root ?>promos/create.php">
                <i class="fas fa-plus"></i>
            ...
            <li><hr class="dropdown-divider my-1"></li>
            <li>
              <a class="dropdown-item text-dark" href="<?= $root ?>category/create.php">
                <i class="fas fa-plus"></i>
            ...
            <li><hr class="dropdown-divider my-1"></li>
            <li>
              <a class="dropdown-item text-dark" href="<?= $root ?>products/create.php">
                <i class="fas fa-plus"></i>
            ...
            <li><hr class="dropdown-divider my-1"></li>
            <li>
              <a class="dropdown-item text-dark" href="<?= $root ?>stores/create.php">
                <i class="fas fa-plus"></i>
            ...
            <li><hr class="dropdown-divider my-1"></li>
            <li>
              <a class="dropdown-item text-dark" href="<?= $root ?>users/create.php">
                <i class="fas fa-plus"></i>
      ...
      <form action="" method="post" class="d-flex col-lg-6" role="search">
